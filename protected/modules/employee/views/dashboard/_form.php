...
<div class="form-group row">
    ...
    <div class="col-lg-4">
        ...
        <?php print CHtml::activeDropDownList($model, 'position_id', CHtml::listData(Utilities::model_getAllData(Positions::model()), 'id', 'name'), array('empty' => 'Select a position', 'class' => 'form-select')); ?>
