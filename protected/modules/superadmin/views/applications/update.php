    ...
    <div class="box-body">
        ...
        <div class="form-group row">
            <div class="col-lg-4 col-md-6">
                ...
                <?php print CHtml::activeDropDownList($model, 'engineer_id', CHtml::listData(Users::model_getPosition(), 'id', function($model) { return $model->firstname . ' ' . $model->lastname; }), array('empty' => 'Select a engineer', 'class' => 'form-select')); ?>
